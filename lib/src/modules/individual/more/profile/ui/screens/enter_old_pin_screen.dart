...
import 'package:rex_app/src/modules/individual/more/profile/providers/change_transaction_pin_provider.dart';
...
class EnterOldPinScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: const RexAppBar(
        ...
        title: StringAssets.enterOldPinTitle,
        subtitle: StringAssets.enterOldPinSubtitle,
      ),
      body: Column(
        children: [
          Expanded(
            child: CustomKeyBoard(
              ...
              onChanged: (v) {
                ...
                pin = v;
                ref.read(oldPinProvider.notifier).onChanged(v);
              },
              onbuttonClick: () {
                if (pin.length < 4) {
                  ...
                  ref.read(oldPinProvider.notifier).onChanged(pin);
