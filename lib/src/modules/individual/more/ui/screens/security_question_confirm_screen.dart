...
class SecurityQuestionConfirmScreen extends ConsumerWidget {
  const SecurityQuestionConfirmScreen({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      appBar: const RexAppBar(
        ...
        title: StringAssets.securityConfirmTitle,
        subtitle: StringAssets.securityConfirmSubtitle,
      ),
      body: Column(
