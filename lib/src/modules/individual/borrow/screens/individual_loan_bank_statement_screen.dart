...
class PublicEmployeeConnectBankScreen extends StatefulHookConsumerWidget {
  const PublicEmployeeConnectBankScreen({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _LoanConnectYourBankScreenState();
}

class _LoanConnectYourBankScreenState
    extends ConsumerState<PublicEmployeeConnectBankScreen> {
