...
class LoanApplicationCard extends StatelessWidget {
  ...
  Color getStatusColor(String title) {
    final statusColors = {
      'PENDING': AppColors.rexAmber,
      'APPROVED': AppColors.rexGreen,
      "APPLIED": AppColors.rexBlue,
      'DECLINED': AppColors.rexRedDark,
    };

    // Return the corresponding icon path or a default string if not found
    return statusColors[title] ?? AppColors.rexBlue;
  }
}
