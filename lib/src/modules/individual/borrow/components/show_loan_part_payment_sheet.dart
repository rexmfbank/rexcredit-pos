...
void showLoanPartPaymentSheet(BuildContext context) {
            ...
            child: Column(
              children: [
                FundSavingSheetTitle(
                  title: StringAssets.loanTermination2,
                  onTap: () => context.pop(),
                ),
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(StringAssets.fundSavingAmount(
                        loanRepayment.amountController.text
