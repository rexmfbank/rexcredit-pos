      ...
      body: Stack(
        children: [
            ...
            child: ListView(
              ...
              children: [
                ...
                profileData.maybeWhen(
                  data: (data) {
                    return RexTextField(
                      outerTitle: Strings.firstNameTitle,
                      showOuterTile: true,
                ...
                profileData.maybeWhen(
                  data: (data) {
                    if (data.middlename.isNotBlank) {
                      return RexTextField(
                        outerTitle: Strings.middleNameTitle,
                        showOuterTile: true,
                ...
                profileData.maybeWhen(
                  data: (data) {
                    ...
                    return RexTextField(
                      outerTitle: Strings.lastNameTitle,
                      showOuterTile: true,
                      controller: null,
                      obscureText: false,
                      hintText: names.last,
                ...
                profileData.maybeWhen(
                  data: (data) {
                    return RexTextField(
                      outerTitle: Strings.phoneNumberTitle,
                      showOuterTile: true,
                ...
                profileData.maybeWhen(
                  data: (data) {
                    return RexCustomTextField(
                      outerTitle: Strings.residentAddressTitle,
                      obscureText: false,
                  ...
                  data: (data) {
                    ...
                    return Padding(
                      ...
                      child: RexFlatButton(
                        ...
                        buttonTitle: Strings.updateButtonTitle,
          ...
          profileData.when(
            ...
            error: (error, stackTrace) => const Text(Strings.profileInfoError),
          ),
        ],
      ),
    );
