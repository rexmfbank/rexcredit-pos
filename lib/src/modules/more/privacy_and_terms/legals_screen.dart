...
class LegalsScreen extends ConsumerStatefulWidget {
  const LegalsScreen({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _LegalsScreen();
}

class _LegalsScreen extends ConsumerState<LegalsScreen> {
  @override
  void initState() {
