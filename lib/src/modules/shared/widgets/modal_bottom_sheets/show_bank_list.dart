...
import 'package:rex_app/src/modules/individual/dashboard_personal/ui/components/transfer_beneficiary_item.dart';
        ...
        children: [
          ...
          Padding(
            ...
            child: RexSearchField(
              ...
              onChanged: (value) =>
                  ref.watch(homeTransferNotifier.notifier).filterBanks(value),
          ...
          Builder(builder: (context) {
            List<BankData> data =
                (ref.watch(homeTransferNotifier).banks.isNotEmpty)
                    ? (ref.watch(homeTransferNotifier).banks
                      ..removeWhere((element) =>
