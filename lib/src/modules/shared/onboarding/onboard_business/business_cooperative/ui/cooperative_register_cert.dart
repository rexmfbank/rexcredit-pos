...
class CooperativeRegisterCert extends ConsumerWidget {
  const CooperativeRegisterCert({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final docState = ref.watch(cooperativeDocProvider);
    return BusinessFileUploadWidget(
      titleText: BusinessFileEnum.CERTIFICATE_OF_REGISTRATION.tag,
      subtitleText: docState.registerCertFile == null
          ? StringAssets.uploadDocInstructions
          : docState.registerCertFileName!,
      docStatus: docState.registerCert,
      onPressed: () => ref
          .read(cooperativeDocProvider.notifier)
          .getFileFromDevice(
              docType: BusinessFileEnum.CERTIFICATE_OF_REGISTRATION),
