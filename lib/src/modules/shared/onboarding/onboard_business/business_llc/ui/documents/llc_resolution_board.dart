...
class LLC_ResolutionBoard extends ConsumerWidget {
  const LLC_ResolutionBoard({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final docState = ref.watch(llcDocProvider);
    return BusinessFileUploadWidget(
      titleText: BusinessFileEnum.BOARD_RESOLUTION.tag,
      subtitleText: docState.resBoardFile == null
          ? StringAssets.uploadDocInstructions
          : docState.resBoardFileName!,
      docStatus: docState.resBoard,
      onPressed: () => ref
          .read(llcDocProvider.notifier)
          .getFileFromDevice(docType: BusinessFileEnum.BOARD_RESOLUTION),
