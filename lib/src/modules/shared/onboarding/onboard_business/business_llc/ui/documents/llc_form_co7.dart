...
class LLC_FormCo7 extends ConsumerWidget {
  const LLC_FormCo7({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final docState = ref.watch(llcDocProvider);
    return BusinessFileUploadWidget(
      titleText: BusinessFileEnum.FORM_Co7.tag,
      subtitleText: docState.formCo7File == null
          ? StringAssets.uploadDocInstructions
          : docState.formCo7FileName!,
      docStatus: docState.formCo7,
      onPressed: () => ref
          .read(llcDocProvider.notifier)
          .getFileFromDevice(docType: BusinessFileEnum.FORM_Co7),
