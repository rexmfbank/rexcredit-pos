...
import 'package:rex_app/src/modules/utils/app_geolocation.dart';
  ...
  Future<void> doPosAuthentication({required BuildContext context}) async {
    ...
    if (serial != null && serial.isNotEmpty) {
      ...
      try {
        ...
        AppSecureStorage().setBaasNuban = posAuth.data.accountNo;
        AppSecureStorage().setBaasNubanName = posAuth.data.accountName;
