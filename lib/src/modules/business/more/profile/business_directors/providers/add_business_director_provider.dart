...
class AddBusinessDirectorsNotifier extends AsyncNotifier<AddDirectorsResponse> {
  @override
  FutureOr<AddDirectorsResponse> build() {
    return AddDirectorsResponse.empty();
  }

  Future<void> addBusinessDirectors(
      {required AddDirectorsRequest request}) async {
