...
final createRepresentativeApiProvider = AsyncNotifierProvider<
    CreateRepresentativeApiNotifier, CreateRepresentativeResponse>(
  () => CreateRepresentativeApiNotifier(),
);

class CreateRepresentativeApiNotifier
    extends AsyncNotifier<CreateRepresentativeResponse> {
  @override
