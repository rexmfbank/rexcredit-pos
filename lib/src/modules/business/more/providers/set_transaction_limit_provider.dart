...
final setWithdrawalLimitProvider = AsyncNotifierProvider<
    SetWithdrawalLimitNotifier, SetWithdrawalLimitResponse>(
...
class SetWithdrawalLimitNotifier
  ...
  Future<void> setWithdrawalLimit(
      {required SetWithdrawalLimitRequest request}) async {
