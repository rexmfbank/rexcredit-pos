...
class PreparePayrollEmployeeLoanScreen extends ConsumerStatefulWidget {
  const PreparePayrollEmployeeLoanScreen({Key? key}) : super(key: key);

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _PreparePayrollEmployeeLoanScreenState();
}

class _PreparePayrollEmployeeLoanScreenState
    extends ConsumerState<PreparePayrollEmployeeLoanScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const RexAppBar(
        ...
        title: 'Employees on Loan',
        subtitle: 'See all employee currently on loan',
      ),
      body: ListView(
        children: [
          Padding(
