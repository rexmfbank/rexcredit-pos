...
import 'package:rex_app/src/modules/business/dashboard/ui/components/dashboard_business_quick_actions.dart';
...
class DashboardBusiness extends ConsumerStatefulWidget {
  const DashboardBusiness({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _DashboardBusinessState();
}

class _DashboardBusinessState extends ConsumerState<DashboardBusiness> {
