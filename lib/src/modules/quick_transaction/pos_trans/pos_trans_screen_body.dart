...
class PosTransactionsScreenBody extends ConsumerStatefulWidget {
  const PosTransactionsScreenBody({super.key, required this.outside});

  final bool outside;

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _PosTransactionsScreenBodyState();
}

class _PosTransactionsScreenBodyState
    extends ConsumerState<PosTransactionsScreenBody> {
  //
      ...
      children: [
        ...
        Flexible(
          ...
          child: Container(
            ...
            child: _buildListContent(posPaginationState, posPaginationNotifier),
          ),
        ),
      ],
    );
