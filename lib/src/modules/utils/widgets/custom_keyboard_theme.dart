...
class CustomKeyboardTheme {
  ...
  const CustomKeyboardTheme.defaults({
  ...
  factory CustomKeyboardTheme(
    ...
    const defaultValues = CustomKeyboardTheme.defaults();
    return CustomKeyboardTheme.defaults(
