...
mixin ResetTransactionPin {
  Future<InitiatePasswordResetResponse> initiateTransactionPinReset({
    ...
    //   path: ApiPath.initiateTransationPinResetV2,
  ...
  Future<ResetTransactionPinResponse> resetTransactionPin({
    required String authToken,
    required String appVersion,
    required ResetTransactionPinRequest request,
  }) async {
    final tokenProvider = AppNetworkProvider();
    ...
    final apiCall = await tokenProvider.call(
      path: ApiPath.resetTransactionPinV2,
      method: RequestMethod.post,
      options: Options(
    ...
    final res = processData(
      (p0) {
        final jsonResponse = EncryptionUtils.decryptFromApi(p0);
        return ResetTransactionPinResponse.fromJson(jsonResponse);
      },
      apiCall,
    );
