        ...
        child: Column(
          ...
          children: [
            TransactionSummaryItem(
              ...
              item: transData.reference ?? 'n/a',
            ),
            const PlanSummaryDivider(),
            TransactionSummaryItem(
              title: Strings.transactionStatus,
              item: transData.statusId ?? 'status n/a',
            ),
            const PlanSummaryDivider(),
            TransactionSummaryItem(
              title: Strings.transactionDate,
              item: transData.transactionDate?.dateReadable() ?? '',
            ),
            const PlanSummaryDivider(),
            TransactionSummaryItem(
            ...
            TransactionSummaryItem(
              ...
              item: transData.transactionDescription ?? 'narration n/a',
            ),
            // const PlanSummaryDivider(),
            // TransactionSummaryItem(
            ...
            // ),
            // transData.statusId == "CARD_PURCHASE"
            //     ? SizedBox.shrink()
...
class PlanSummaryDivider extends StatelessWidget {
  const PlanSummaryDivider({super.key});
