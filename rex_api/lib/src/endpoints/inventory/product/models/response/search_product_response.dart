...
class SearchProductResponse {
  ...
  SearchProductResponse copyWith({
    String? responseCode,
    String? responseMessage,
    List<SearchProductResponseData>? data,
  }) =>
  ...
  factory SearchProductResponse.fromRawJson(String str) => SearchProductResponse.fromJson(json.decode(str));
  ...
  factory SearchProductResponse.fromJson(Map<String, dynamic> json) => SearchProductResponse(
    ...
    data: json["data"] == null ? [] : List<SearchProductResponseData>.from(json["data"]!.map((x) => SearchProductResponseData.fromJson(x))),
  );
...
class SearchProductResponseData {
  ...
  SearchProductResponseData copyWith({
    DateTime? createdDate,
    String? createdBy,
    String? modifiedBy,
    DateTime? modifiedDate,
  ...
  factory SearchProductResponseData.fromRawJson(String str) => SearchProductResponseData.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory SearchProductResponseData.fromJson(Map<String, dynamic> json) => SearchProductResponseData(
