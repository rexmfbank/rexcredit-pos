...
import 'package:rex_api/src/endpoints/profile/get_next_of_kin/models/get_next_of_kin_response.dart';
import 'package:rex_api/src/endpoints/shared_models/error_data.dart';
  ...
  Future<GetNextOfKinResponse> getNextOfKin({required String token}) async {
    try {
      ...
      if (apiResponse.responseCode == ErrorCode.SUCCESS) {
        return GetNextOfKinResponse.fromJson(response.data);
      }
